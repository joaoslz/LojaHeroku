...
@Entity
public final class DetalhesImagemProduto implements Serializable {
    ...
    public DetalhesImagemProduto() {
    }

    public DetalhesImagemProduto(String imagemPath, String nomeArquivo, Long tamanhoArquivo, 
    		                   String tipoArquivo) {
